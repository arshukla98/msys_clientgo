...
import (
	...
	"github.com/arshukla98/msys_clientgo/pkg/generated/clientset/versioned/scheme"
...
// MonitoringV1Client is used to interact with features provided by the monitoring.core.example.com group.
type MonitoringV1Client struct {
	restClient rest.Interface
}

func (c *MonitoringV1Client) PromCRs(namespace string) PromCRInterface {
	return newPromCRs(c, namespace)
}
